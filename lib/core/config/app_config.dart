...
class AppConfig {
  ...
  static String get currentNativeAdUnitId => isProduction ? nativeAdUnitId : testNativeAdUnitId;
  static String get currentBannerAdUnitId => isProduction ? bannerAdUnitId : testBannerAdUnitId;
